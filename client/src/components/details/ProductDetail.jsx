...
const ProductDetail = ({ product }) => {
    ...
    return (
        <>
            <Typography style={{ marginTop: 32 }}>{product.title.longTitle}</Typography>
            <Typography style={{ marginTop: 5, color: '#878787', fontSize: 14 }}>
                8 Rating & 1 Review
                <Box component="span"><img src={fassured} style={{ width: 77, marginLeft: 20 }} /></Box>
            </Typography>
            <Typography>
                <Box componenet="span" style={{ fontSize: 28 }}>₹{product.price.cost}</Box>&nbsp;&nbsp;&nbsp;
            ...
            <SmallText>
                ...
                <Typography><StyledBadge />Buy 2 itmes save 5%;Buy 3 or more save 10% T&C</Typography>
                ...
                <TableBody>
                    ...
                    <ColumnText>
                        ...
                        <TableCell>
                            ...
                            <Typography>View more sellers staring from ₹{product.price.cost}</Typography>
                        </TableCell>
                    </ColumnText>
                    <ColumnText>
                        <TableCell colSpan={2}>
